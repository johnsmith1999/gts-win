...
void          gts_point_transform                    (GtsPoint * p, 
						      GtsMatrix * m);
//add
void          gts_point_translate                    (GtsPoint * p,
                                                      GtsPoint * q);
...
GtsIntersect  gts_segments_are_intersecting          (GtsSegment * s1,
						      GtsSegment * s2);
//add
GSList *      gts_segment_segment_intersection       (GtsSegment * s1,
                                                      GtsSegment * s2);
//-----
...
void         gts_surface_write_vtk         (GtsSurface * s, 
					    FILE * fptr);
//add
void         gts_surface_write_msh         (GtsSurface * s,
                                            FILE * fptr, int nsup);
//---->
