 ...
 * gts_point_translate:
 * @p: a #GtsPoint.
 * @q: the #GtsPoint representing the translation to
 * apply to the coordinates of @p.
 *
 * Translate the coordinates of @p according to @q. (p becomes p+q).
 */
void gts_point_translate (GtsPoint * p, GtsPoint * q)
{
  g_return_if_fail (p != NULL && q != NULL);
